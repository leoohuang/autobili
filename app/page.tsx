...
export default function Page() {
  ...
  async function handleDebugSubtitle() {
    ...
    try {
      ...
      // Guard against non-JSON error bodies (e.g. B站返回HTML错误页时)
      // by checking response.ok before parsing. This prevents JSON.parse
      // from throwing on malformed HTML and surfacing an unhandled exception.
      if (!response.ok) {
